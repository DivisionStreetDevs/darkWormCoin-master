...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.darkWormcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.darkWormcointools.com", true);
        vSeeds.emplace_back("dnsseed.darkWormcoinpool.org", true);

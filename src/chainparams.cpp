...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1516845876, 22, 0x1e0ffff0, 1, 50 * COIN);
        ...
        chainTxData = ChainTxData{
            ...
            1516251642, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.darkWormcointools.com", true);
        vSeeds.emplace_back("seed-b.darkWormcoin.loshan.co.uk", true);

...
#if defined(NDEBUG)
# error "darkWormcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "darkWormcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DRWM additional fees, %d delta bytes\n",

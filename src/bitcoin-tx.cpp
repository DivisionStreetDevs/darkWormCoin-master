...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s darkWormcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  darkWormcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded darkWormcoin transaction") + "\n" +
              "  darkWormcoin-tx [options] -create [commands]   " + _("Create hex-encoded darkWormcoin transaction") + "\n" +
              "\n";

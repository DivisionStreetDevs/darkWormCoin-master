...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/darkWormcoin-project/darkWormcoin>";
    const std::string URL_WEBSITE = "<https://darkWormcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("darkWormcoin version %s\n", FormatFullVersion());
}
